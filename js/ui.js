...
const UI = (() => {
  ...
  function _critListHTML() {
    ...
    State.TIERS.forEach(t=>{
      ...
      html+=`<div style="margin-bottom:6px;font-family:var(--font-mono);font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:${State.TIER_COLORS[t]};padding:4px 0 2px" data-tip="${_TIP[t]}">${TIER_LABEL[t]}</div>`;
